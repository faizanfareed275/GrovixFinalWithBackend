...
const navSections: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/internship-v2-templates", label: "Task Templates", icon: Target },
      { to: "/admin/internship-v2-badge-rules", label: "Badge Rules", icon: Award },
      { to: "/admin/internship-v2-assignments", label: "Assignments", icon: Target },
      { to: "/admin/internship-v2-attempts", label: "Attempts", icon: ClipboardCheck },
      { to: "/admin/internship-v2-batches", label: "Batches", icon: Calendar },
      { to: "/admin/internship-v2-applications", label: "Applications", icon: Users },
      { to: "/admin/internship-v2-enrollments", label: "Enrollments", icon: Briefcase },
      { to: "/admin/internship-v2-analytics", label: "Analytics", icon: LayoutDashboard },
    ],
  },
  {
    title: "Communication",
